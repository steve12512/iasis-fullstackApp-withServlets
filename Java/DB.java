...
public class DB {
	...
	// changed the variables for obvious reasons.
	private final String dbServer = "this_is_not_the_right_server";
	private final String dbServerPort = "3306";
	private final String dbName = "ismgroup39";
	private final String dbusername = "ismgroup39";
	private final String dbpassword = "#this_is_not_the_right_password";
